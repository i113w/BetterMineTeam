...
public class PatrolCombatLeashGoal extends Goal implements TeamGoal {
    ...
    @Override public boolean canContinueToUse() { return data.getPatrolTask().isEnabled(); }
    @Override public void start() { checkTicker = 0; }
    ...
    @Override public void tick() {
        ...
        if (data.getCommand() == CommandType.ATTACK) data.stop();
    }
}
